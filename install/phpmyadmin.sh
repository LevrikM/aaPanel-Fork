...
Install_phpMyAdmin()
{
    ...
    PHPVersion=""
	for phpVer in 52 53 54 55 56 70 71 72 73 74 80 81 82 83 84 85;
	do
	...
	if [ -z $PHPVersion ];then
	    echo "======================================"
	    echo "当前没有可用php，停止安装！ There is currently no available php, stop installation!"
	    echo "请先安装好php后再进行安装phpmyadmin！ Please install php first and then install phpmyadmin!"
	    exit 1;
	fi
